...
class Paths
{
	...
	static public function getTextFromFile(key:String, ?ignoreMods:Bool = false):String
	{
		...
		var pathShared:String = getSharedPath(key);
		if (OpenFlAssets.exists(pathShared, TEXT))
		{
			return OpenFlAssets.getText(pathShared);
		}

		var pathDefault:String = getPath(key, TEXT);
		if (OpenFlAssets.exists(pathDefault, TEXT))
		{
